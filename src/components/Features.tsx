  ...
  return (
    <div className="my-[100px]">
      <div className=" grid grid-cols-18 gap-5">
        <div className=" col-span-9    border border-white rounded-[23px] px-[30px] py-[25px] group hover:bg-primary hover:border-primary transition-all duration-300">
          ...
          <Button3 color="white" className="opacity-0 group-hover:opacity-100">Get Started</Button3>
        </div>
        <div className=" col-span-9    border border-white rounded-[23px] px-[30px] py-[25px] group hover:bg-primary hover:border-primary transition-all duration-300">
        ...
        <div className=" col-span-4    row-span-2 border border-white rounded-[23px] px-[30px] py-[25px] group hover:bg-primary hover:border-primary transition-all duration-300">
        ...
        <div className=" col-span-4     border border-white rounded-[23px] px-[30px] py-[25px] group hover:bg-primary hover:border-primary transition-all duration-300">
        ...
        <div className="  col-span-7    border border-white rounded-[23px] px-[30px] py-[25px] group hover:bg-primary hover:border-primary transition-all duration-300">
