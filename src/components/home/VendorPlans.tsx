  ...
  return (
    <div className="pt-[100px] pb-[120px]">
      <div className="flex items-center justify-between mb-[60px]">
        <div>
          <Heading2 className="mb-[30px]">Choose Idle plan for vendor</Heading2>
          <Paragraph>
        ...
        <div className="relative flex items-center gap-5 ">
          <h1 className="text-[150px] leading-none tracking-[3px] font-[700]  text-outline-shadow-primary font-manrope mr-[50px]">
            250+
          </h1>
          <h6 className="absolute -right-[38px] text-[24px] font-[600] font-jakarta uppercase rotate-90   whitespace-nowrap">
            VENDORS
          </h6>
        </div>
      </div>
      <div className="relative w-screen left-1/2 -translate-x-1/2  ">
        <div className="grid grid-cols-2 h-[650px] border-t border-b border-white">
          <div className="flex items-end justify-start relative group outline  transition-all duration-300 ease-in-out">
            <div className="p-[70px] z-30 transition-all duration-300 ease-in-out">
              <Heading4 className="text-primary mb-[20px]">Executive</Heading4>
              <SubHeading1 className="mb-[40px] group-hover:opacity-0 group-hover:hidden  transition-all duration-300 ease-in-out">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore et dolore magna.
              </SubHeading1>
              <div className="hidden group-hover:flex flex-col gap-5 mb-10">
            ...
            <div className="absolute opacity-0 group-hover:opacity-100 top-[50%] -translate-y-[50%] w-full  h-[110%] transition-all duration-300 ease-in-out">
              <Image
